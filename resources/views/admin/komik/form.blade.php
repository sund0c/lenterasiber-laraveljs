...
<label>Deskripsi <span style="color:var(--muted);font-weight:normal">(opsional)</span></label>
          <textarea name="description" rows="3"
            ...
            maxlength="2000" required>{{ old('description', $item->description ?? '') }}</textarea>
          @error('description')
            <p class="field-error">{{ $message }}</p>
          @enderror
        </div>
    ...
    <div class="card" style="margin-bottom:1rem">
      ...
      <div class="card-body">
        ...
        <div class="form-row">
          <div class="form-group">
            <label>Urutan Tampil <span style="color:var(--red)">*</span></label>
            <input type="number" name="sort_order"
              class="form-input @error('sort_order') is-error @enderror"
