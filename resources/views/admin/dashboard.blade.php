...
@section('content')
    <div class="stats-grid">
        ...
        <div class="stat-card">
            <div class="stat-icon"><svg width="20" height="20" viewBox="0 0 24 24" fill="none"
            ...
            <table>
                ...
                <tbody>
                    @forelse($recentAudit as $log)
                        <tr>
                            <td style="font-size:0.78rem;color:var(--muted)">{{ $log->created_at->format('d/m/Y H:i') }}
                            </td>
                    ...
                    @empty
                        <tr>
                            <td colspan="4" style="text-align:center;color:var(--muted);padding:2rem">Belum ada
                                aktivitas.</td>
                        </tr>
                    @endforelse
                </tbody>
